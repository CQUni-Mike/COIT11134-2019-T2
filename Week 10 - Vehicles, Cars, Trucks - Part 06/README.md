...
??.	Fix the Exit button (only exit if they click YES).
...
It does NOT include iOS, Android, Windows Phone, web, etc, etc ...
So much for Java's long-time promise of "Write Once, Run Anywhere" ....

What if we wanted to create a Console version of our application ?
...
Our GUI app does a lot more than just handle the GUI ....
why repeat all of thet business logic in multiple places ?
...
(implements Comparable)  search for vehicle before adding it.
...
## Question 5: File I/O, Delete, JTabbedPane, ....
TBA
