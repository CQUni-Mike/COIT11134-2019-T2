...
public class VehicleGUI extends JFrame
{
   ...
   private void testData()
   {
      ...
      vehicles[numVehiclesSoFar] = v1;
      numVehiclesSoFar++;

      vehicles[numVehiclesSoFar] = v2;
      numVehiclesSoFar++;

      vehicles[numVehiclesSoFar] = v3;
      numVehiclesSoFar++;
      //if (numVehiclesSoFar >= vehicles.length)
      //{
      //   ERRROR - no more space in the array.
      //}
   ...
   private void fileWrite()
   {
     ...
     try
     {
       ...
       for (int k = 0; k < numVehiclesSoFar; k++)
       {
         ...
         outputFile.format ("%s\n", vehicles[k].getModel () );
         outputFile.format ("%s\n", vehicles[k].getBuildDate () );
         outputFile.format ("%s\n", vehicles[k].getFuelEcon () );
       ...
       System.out.println (numVehiclesSoFar + " lines written to: " + fileName);
     }
